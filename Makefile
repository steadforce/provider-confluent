...
REGISTRY_ORGS ?= ghcr.io/steadforce # xpkg.upbound.io/crossplane-contrib
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= ghcr.io/steadforce # xpkg.upbound.io/crossplane-contrib
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= ghcr.io/steadforce # xpkg.upbound.io/crossplane-contrib
XPKGS = $(PROJECT_NAME)
